...
console.log(window.scrollY);
  ...
  if(window.scrollY > 550 && window.scrollY<1030)
  {
    marginY=window.scrollY;
  }
  ...
  if(err) {
    ...
    if(obj!=null){
      ...
      var template = '  <li class="box carousel_each" id="boxes">\
                ...
                var wide=end*50;
                document.getElementById('first').style.width=wide+'%';
...
if(current_index==0){
 ...
 function slideLeft() {
  if(current_index <= min_index){
    ...
    var slideValue = -1088 * current_index
    var slideString = String(slideValue)
    document.getElementById("first").style.transform = "translateX(" + slideString + "px)"
  }
 }
